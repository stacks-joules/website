/** Single source of truth for the donation campaign URL */
export const donationLink = `https://giving.gofundme.com/campaign/700902/donate`;

/** In-page anchor for the Get in Touch form (rendered on every page) */
